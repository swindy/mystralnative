...
// Surface texture status - Dawn uses WGPUStatus for SurfaceTexture.status
#define WGPU_SURFACE_TEXTURE_STATUS_TYPE WGPUStatus
#define WGPUSurfaceGetCurrentTextureStatus_Success_Compat WGPUStatus_Success
#define WGPUSurfaceGetCurrentTextureStatus_SuccessSuboptimal_Compat WGPUStatus_Success
#define WGPUSurfaceGetCurrentTextureStatus_Error_Compat WGPUStatus_Error
...
#else // MYSTRAL_WEBGPU_WGPU (wgpu-native)
// ============================================================================
