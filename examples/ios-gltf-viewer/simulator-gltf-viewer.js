...
// Uses vertex buffer instead of array indexing for iOS compatibility
const skyboxShaderCode = /* wgsl */`
    ...
    fn vs_main(input: VertexInput) -> VertexOutput {
        ...
        let clipPos = scene.projectionMatrix * view * vec4f(input.position, 1.0);
...
// Skybox cube vertex data (36 vertices)
